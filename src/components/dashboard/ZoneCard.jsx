...
const ZoneCard = ({
  ...
  return (
    <div
      className={`bg-white p-4 rounded-xl shadow-sm justify-between transition transform text-white border border-white hover:border-[--border-color]`}
    >
      ...
      >
        ...
        <span
          className={`flex gap-2 text-[12px] items-center ${changeType === "up" ? "text-red-700" : "text-blue-500"
            }`}
        >
