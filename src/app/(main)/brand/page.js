...
const page = () => {
    ...
    const SelectBrandData = brandData.find((bc) => bc.brandCode === activeBrand || bc.brandCode === auth?.brandCode);

    return (
        <>
            {
                auth?.role === "admin" && (<section className='wrapper max-w-screen-sm mx-auto p-4 mt-2'>
                    <BackButton />
